...
$dbname = "bursary_applications_uni";
        ...
        <table>
            ...
            <?php foreach ($applicants as $applicant): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($applicant['name_of_university']); ?></td>
                    <td><?php echo htmlspecialchars($applicant['branch']); ?></td>
                    <td><?php echo htmlspecialchars($applicant['level_of_study']); ?></td>
                    <td><?php echo htmlspecialchars($applicant['course_of_study']); ?></td>
                    <td><?php echo htmlspecialchars($applicant['mode_of_study']); ?></td>
                    <td><?php echo htmlspecialchars($applicant['year_of_study']); ?></td>
                    ...
                    <td><?php echo htmlspecialchars($applicant['college_funding']); ?></td>
                    <td><?php echo htmlspecialchars($applicant['university_funding']); ?></td>
